...
const ViewersAds = (props) => {
    return (<Container >
        {/* <Wrap >
            <img src='/images/0frame0.jpg' alt='' />
            <video autoPlay loop muted >
                <source src="/videos/Bakst sumažintas.mp4" type='video/mp4' />
            </video>
        </Wrap> */}
        <Wrap>
        ...
        {/* <Wrap ratio={'grid-column: 3/ 5;grid-row: 1 / 1;'} >
        ...
        <Wrap>
            ...
            <video autoPlay loop muted >
                <source src='/videos/Scanorama sumazintas su garsu.mp4' type='video/mp4' />
            </video>
        </Wrap>
        {/* <Wrap>
            <img src='/images/8frame0.jpg' alt='' />
            <video autoPlay loop muted >
